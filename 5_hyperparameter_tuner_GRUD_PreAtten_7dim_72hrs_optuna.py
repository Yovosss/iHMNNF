...
arg_parser.add_argument('--max_timestamp', type=int, default=72*60*60,choices=[48*60*60, 72*60*60, 96*60*60, 120*60*60],
...
model_path = os.path.join(ARGS.working_path, 'model_tuning', 'phase_viii', '72hours', '20220604', 'GRUD_PreAttenSpatial_7dim_72hrs_Paper(optuna)')
if not os.path.exists(model_path):
    os.makedirs(model_path)
output_path = os.path.join(ARGS.working_path, 'output', 'phase_viii', '72hours', '20220604', 'GRUD_PreAttenSpatial_7dim_72hrs_Paper(optuna)')
