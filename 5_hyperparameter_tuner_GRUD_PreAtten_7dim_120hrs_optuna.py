...
from attention import Attention as PosAttention
...
arg_parser.add_argument('--max_timestamp', type=int, default=120*60*60,choices=[48*60*60, 72*60*60, 96*60*60, 120*60*60],
...
model_path = os.path.join(ARGS.working_path, 'model_tuning', 'phase_viii', '120hours', '20220604', 'GRUD_PreAttenSpatial_7dim_120hrs_Paper(optuna)')
if not os.path.exists(model_path):
    os.makedirs(model_path)
output_path = os.path.join(ARGS.working_path, 'output', 'phase_viii', '120hours', '20220604', 'GRUD_PreAttenSpatial_7dim_120hrs_Paper(optuna)')
...
LABEL_DICT = {'-1':'flatten multi-classification', 
              ...
              '4':'HM and SM'}
# Load the data
dataset = LoadDataTrial(data_path=os.path.join('.', 'data', 'phase_viii', '120hours', 'processed', 'raw/data4hc_v20220401'), 
...
if __name__ == '__main__':
    ...
    study = optuna.create_study(direction='maximize', 
                                ...
                                # pruner=optuna.pruners.MedianPruner(),
                                load_if_exists=True,
                                study_name='GRUD(HM and SM)_20220711150350')
