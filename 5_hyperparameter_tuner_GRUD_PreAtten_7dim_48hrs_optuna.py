...
model_path = os.path.join(ARGS.working_path, 'model_tuning', 'phase_viii', '48hours', '20220604', 'GRUD_PreAttenSpatial_7dim_48hrs_Paper(optuna)')
if not os.path.exists(model_path):
    os.makedirs(model_path)
output_path = os.path.join(ARGS.working_path, 'output', 'phase_viii', '48hours', '20220604', 'GRUD_PreAttenSpatial_7dim_48hrs_Paper(optuna)')
...
if __name__ == '__main__':
    ...
    study = optuna.create_study(direction='maximize', 
                                ...
                                pruner=optuna.pruners.MedianPruner(),
                                load_if_exists=True,
                                study_name='GRUD(infectious and non-infectious)_20220628141724')
